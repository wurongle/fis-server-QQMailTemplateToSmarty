...
require_once ROOT . 'QQMailTemplateToSmarty.class.php';
...
class TestData {
    ...
    public static function init() {
        ...
        $datatype = 'json';//$_COOKIE['FIS_DEBUG_DATATYPE'];
    ...
    public static function renderHelper($template_instance, $candidate_tmpl ,$noSmartyParse) {
        ...
        if($noSmartyParse){
            ...
            fwrite($file,$content);
            fclose($file);
            $template_instance->display($new_tmpl_file_name);
        }
